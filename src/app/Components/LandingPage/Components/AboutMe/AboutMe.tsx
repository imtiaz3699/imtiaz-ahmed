...
function AboutMe() {
  return (
    <div className={`  bg-[#111827] px-[10px] w-full sm:px-[30px] md:px-[30px] lg:px-[120px] flex flex-col items-center gap-[50px] justify-center py-[50px] md:py-[100px] ${inter.className}`}>
        <div className='bg-[#374151] text-[18px] px-5 py-2 rounded-[25px] text-gray-400'>About me</div>
        <div className='flex flex-col md:flex-row items-center md:items-start justify-center  w-full gap-[50px]'>
            <div className='bg-[#374151] h-[240px] w-[230px] flex justify-center md:h-[480px] md:w-[400px] relative'>
                <img src={ProfilePhoto.src} alt=""  className='absolute md:-right-6 -top-3 md:-top-6  h-[240px] w-[200px]  md:h-[480px] md:w-[400px] border-b-[6px] border-l-[6px] border-r-[6px] md:border-r-0 border-[#111827] '/> 
            </div>
            <div className={` md:max-w-[70%] w-full text-[18px] text-[#D1D5DB] flex flex-col gap-[20px]`}>
